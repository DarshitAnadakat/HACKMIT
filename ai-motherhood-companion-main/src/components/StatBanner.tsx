...
const StatBanner = () => {
  ...
  return (
    ...
    >
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-mother-pink-dark via-emergency to-mother-blue-dark opacity-90"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 relative">
        <div className="flex items-center justify-center text-center text-sm sm:text-base font-medium">
          <div className="relative z-10 flex items-center justify-center text-white">
            <AlertTriangle className="mr-2 h-5 w-5 animate-pulse text-white" />
